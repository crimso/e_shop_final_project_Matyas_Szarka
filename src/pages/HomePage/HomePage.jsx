...
export const HomePage = () => {
  return (
    <section className="w-full py-12 mx-8 md:py-24 lg:py-32 xl:py-48 bg-white rounded-lg shadow-xl my-4 md:my-8 lg:my-12 grow-0 transition-all duration-300 ease-in-out">
